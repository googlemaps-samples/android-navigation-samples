...
public abstract class PermissionUtils {
  ...
  public static boolean isPermissionGranted(
      String[] grantPermissions, int[] grantResults, String permission) {
  ...
  public static class PermissionDeniedDialog extends DialogFragment {
    ...
    /**
     * Creates a new instance of this dialog and optionally finishes the calling Activity when the
    ...
    public void onDismiss(DialogInterface dialog) {
      ...
      if (finishActivity) {
        Toast.makeText(getActivity(), R.string.permission_required_toast, Toast.LENGTH_SHORT)
            .show();
        getActivity().finish();
      }
    }
   ...
   * permission.
   *
   * <p>The activity should implement {@link
   * androidx.core.app.ActivityCompat.OnRequestPermissionsResultCallback} to handle permit or denial
  ...
  public static class RationaleDialog extends DialogFragment {
     ...
     *     to the {@link androidx.core.app.ActivityCompat.OnRequestPermissionsResultCallback}.
