...
/** Polyline control fragment pager adapter. */
public class PolylineControlFragmentPagerAdapter extends FragmentPagerAdapter {
  ...
  public PolylineControlFragmentPagerAdapter(FragmentManager fragmentManager) {
  ...
  public Fragment getItem(int position) {
    switch (position) {
      ...
      case 6:
        return PolylineSpansControlFragment.newInstance();
      case 7:
