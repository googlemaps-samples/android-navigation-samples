...
public final class DemoDetailsList {
  ...
  public static final DemoDetails[] DEMOS = {
    ...
    new DemoDetails(
        R.string.camera_demo_label, R.string.camera_demo_description, CameraDemoActivity.class),
    new DemoDetails(
        R.string.circle_demo_label, R.string.circle_demo_description, CircleDemoActivity.class),
    new DemoDetails(
        R.string.day_night_circle_demo_label,
        R.string.day_night_circle_demo_description,
        DayNightCircleDemoActivity.class),
    new DemoDetails(
        R.string.events_demo_label, R.string.events_demo_description, EventsDemoActivity.class),
    new DemoDetails(
        R.string.ground_overlay_demo_label,
        R.string.ground_overlay_demo_description,
        GroundOverlayDemoActivity.class),
    new DemoDetails(
        R.string.indoor_demo_label, R.string.indoor_demo_description, IndoorDemoActivity.class),
    new DemoDetails(
        R.string.indoor_multi_map_demo_label,
        R.string.indoor_multi_map_demo_description,
        IndoorMultiMapDemoActivity.class),
    new DemoDetails(
        R.string.layers_demo_label, R.string.layers_demo_description, LayersDemoActivity.class),
    new DemoDetails(
        R.string.map_in_pager_demo_label,
        R.string.map_in_pager_demo_description,
        MapInPagerDemoActivity.class),
    new DemoDetails(
        R.string.map_styling_demo_label,
        R.string.map_styling_demo_description,
        MapStylingDemoActivity.class),
    new DemoDetails(
        R.string.marker_anchors_demo_label,
        R.string.marker_anchors_demo_description,
        MarkerAnchorsDemoActivity.class),
    new DemoDetails(
    ...
    new DemoDetails(
        R.string.marker_demo_label, R.string.marker_demo_description, MarkerDemoActivity.class),
    new DemoDetails(
        R.string.marker_z_index_demo_label,
        R.string.marker_z_index_demo_description,
        MarkerZIndexDemoActivity.class),
    new DemoDetails(
        R.string.multi_map_demo_label,
        R.string.multi_map_demo_description,
        MultiMapDemoActivity.class),
    new DemoDetails(
        R.string.multi_map_with_nav_drawer_demo_label,
        R.string.multi_map_with_nav_drawer_demo_description,
        MultiMapWithNavDrawerDemoActivity.class),
    new DemoDetails(
        R.string.my_location_demo_label,
        R.string.my_location_demo_description,
        MyLocationDemoActivity.class),
    new DemoDetails(
        R.string.on_poi_click_demo_label,
        R.string.on_poi_click_demo_description,
        OnPoiClickDemoActivity.class),
    new DemoDetails(
        R.string.options_demo_label, R.string.options_demo_description, OptionsDemoActivity.class),
    new DemoDetails(
    ...
    new DemoDetails(
        R.string.street_view_lat_lng_anywhere_demo_label,
        R.string.street_view_lat_lng_anywhere_demo_description,
        StreetViewLatLngAnywhereDemoActivity.class),
    new DemoDetails(
        R.string.street_view_multiple_panorama_demo_label,
        R.string.street_view_multiple_panorama_demo_description,
        StreetViewMultiplePanoramaDemoActivity.class),
    new DemoDetails(
        R.string.street_view_panorama_anywhere_demo_label,
        R.string.street_view_panorama_anywhere_demo_description,
        StreetViewPanoramaAnywhereDemoActivity.class),
    new DemoDetails(
    ...
    new DemoDetails(
        R.string.polygon_demo_label, R.string.polygon_demo_description, PolygonDemoActivity.class),
    new DemoDetails(
    ...
    new DemoDetails(
        R.string.raw_view_demo_label,
        R.string.raw_view_demo_description,
        RawViewDemoActivity.class),
    new DemoDetails(
        R.string.retain_map_demo_label,
    ...
    new DemoDetails(
        R.string.tags_demo_label, R.string.tags_demo_description, TagsDemoActivity.class),
    new DemoDetails(
    ...
    new DemoDetails(
        R.string.tile_overlay_on_styled_map_demo_label,
        R.string.tile_overlay_on_styled_map_demo_description,
        TileOverlayOnStyledMapDemoActivity.class),
    new DemoDetails(
        R.string.toolbar_demo_label, R.string.toolbar_demo_description, ToolbarDemoActivity.class),
    new DemoDetails(
        R.string.top_styles_demo_label,
        R.string.top_styles_demo_description,
        TopStylesDemoActivity.class),
    new DemoDetails(
    ...
    new DemoDetails(
        R.string.z_index_demo_label, R.string.z_index_demo_description, ZIndexDemoActivity.class),
  };
}
