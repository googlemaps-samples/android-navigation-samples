...
/** Fragment with "stroke joint" UI controls for polygons, to be used in ViewPager. */
public class PolygonJointControlFragment extends PolygonControlFragment
    implements RadioGroup.OnCheckedChangeListener {
  private final Map<Integer, Integer> radioIdToJointType = new HashMap<>();
  private RadioGroup jointRadioGroup;

  public PolygonJointControlFragment() {
    radioIdToJointType.clear();
  ...
  public void onDestroyView() {
    jointRadioGroup.setOnCheckedChangeListener(null);
    jointRadioGroup = null;
