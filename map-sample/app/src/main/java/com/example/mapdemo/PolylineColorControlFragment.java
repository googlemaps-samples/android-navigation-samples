...
public class PolylineColorControlFragment extends PolylineControlFragment
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle) {
    ...
    alphaBar = (SeekBar) view.findViewById(R.id.alphaSeekBar);
    alphaBar.setMax(ALPHA_MAX);
    alphaBar.setOnSeekBarChangeListener(this);

    hueBar = (SeekBar) view.findViewById(R.id.hueSeekBar);
  ...
  public void onDestroyView() {
    alphaBar.setOnSeekBarChangeListener(null);
    hueBar.setOnSeekBarChangeListener(null);
