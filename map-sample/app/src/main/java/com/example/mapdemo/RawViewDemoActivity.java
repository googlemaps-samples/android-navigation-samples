 ...
 * This requires forwarding all the important lifecycle methods onto the respective view.
 */
public class RawViewDemoActivity extends AppCompatActivity implements OnMapReadyCallback {
